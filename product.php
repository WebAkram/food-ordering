...
if( mysqli_num_rows($result1) > 0){
 ...
 if($page > 1){
    echo '<li class="prev  me-2"><a  href="product.php?page='.($page - 1).'"> &nbsp; Prev &nbsp;&nbsp;</a></li>';
 }
  ...
  echo '<li class="ms-3 a" ><a class="'.$active.'"  href="product.php?page='.$i.'">'.$i.'</a></li>';
    } 
    if($total_page > $page){
        echo '<li class="next ms-2"><a href="product.php?page='.($page + 1).'"> &nbsp;&nbsp; Next &nbsp; </a></li>';
     }
